...
class MessageController extends Controller {
    ...
    public function index() {
        $data = array(
            'title' => 'Гостевая книга на Laravel 5.7',
    ...
    public function show(Message $message) {
        ...
        $previus = Message::where('id', '<', $message->id) // только те записи, у которых id меньше чем у нынешней.
                ->select('id') // лишь поле ID
                ->orderby('id', 'desc') // сортировка данных по убыванию содержания ячейки 'id'
        ...
        // $previusID = Message::where('id', '<', $message->id)->select('id')->orderby('id','desc')->firstOrNew([])->id; // альтернатива
        ...
        $data = array(
            'title' => 'Гостевая книга на Laravel 5.7.<br> Просмотр сообщения.',
